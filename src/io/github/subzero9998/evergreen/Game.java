...
import io.github.subzero9998.evergreen.input.Keyboard;
...
public class Game extends Canvas implements Runnable {
	...
	public static int height = width / 16 * 9; // sets the height of the game to
												// 16:9
	public static int scale = 3; // scales the window up 3x
	public static String title = "Evergreen";
